        ...
        <Layout className="pt-2 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col ">
            ...
            <div className="w-3/5 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <AnimatedText
                text="Hi! 👋 I'm Gaurav    "
                className="text-4xl  !text-left xl:!text-4xl lg:!text-center lg:!text-5xl lg:!mb-1  md:!text-5xl sm:!text-xl sm:!mb-1"
                fontColour="!text-black"
              />
              <AnimatedText
                text="ML | Data Science Engineer"
                fontColour="!text-black-500"
                className="text-3xl !text-left 3xl:!text-xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl"
              />
